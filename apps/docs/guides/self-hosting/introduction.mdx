...
<Note>
  ...
  compose](https://github.com/opscape/kan/blob/main/docker-compose.yml) in the
...
<Steps>
  <Step title="Create a docker-compose.yml">
    ...
    <Tip>
      The example above is intentionally minimal. The repository provides a more feature-complete compose file at [docker-compose.yml](https://github.com/opscape/kan/blob/main/docker-compose.yml) if you want environment-based configuration, OAuth, S3, and more.
    </Tip>
  ...
  <Step title="Configure environment (optional)">
    ...
    <Accordion title="Common variables">
      ...
      # Optional: Email
      EMAIL_FROM="Kan <hello@mail.opscape.com>"
...
- [GitHub README](https://github.com/opscape/kan/blob/main/README.md#self-hosting-)
- [GitHub docker-compose.yml](https://github.com/opscape/kan/blob/main/docker-compose.yml)
