---
title: Introduction
description: "Opscape Kan is the open source alternative to Trello."
---
...
<CardGroup cols={2}>
  <Card title="Cloud" icon="cloud" href="https://opscape.com/signup">
  ...
  <Card
    title="Self-host"
    icon="code"
    href="https://github.com/opscape/kan?tab=readme-ov-file#self-hosting-"
  >
