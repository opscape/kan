...
- <code>NEXT_PUBLIC_AVATAR_URL</code> → optional public CDN base URL for avatars
...
- [Kan README](https://github.com/opscape/kan/blob/main/README.md)
- [Cloud compose reference](https://github.com/opscape/kan/blob/main/cloud/docker-compose.yml)
- [Kan #109 Issue](https://github.com/opscape/kan/issues/109)
